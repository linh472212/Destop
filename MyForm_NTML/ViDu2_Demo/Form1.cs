...
namespace ViDu2_Demo
{
    public partial class frmGiaoVien : Form
    {
        ...
        private void frmGiaoVien_Load(object sender, EventArgs e)
        {
            ...
            this.linklbLienHe.Links.Add(0, lienhe.Length, lienhe); this.cboMaSo.SelectedItem = this.cboMaSo.Items[0];
        }
        ...
        private void lbMonHocDay_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        public void ReSet()
        {
            ...
            //Chuyển các môn từ 1bMonHocDay sang 1bDanhMucMH
